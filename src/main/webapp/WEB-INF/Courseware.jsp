    ...
    <div id="container">
        ...
        <div id="header">
            <div class="login_wrapper">
                <a href="denglu.jsp" id="header_top1">&nbsp;&nbsp;登录&nbsp;&nbsp;</a><span>|</span>
                <a href="zhuce.jsp" id="header_top2">&nbsp;&nbsp;注册</a>
            </div>
            <a class="search-back">
        ...
        <div class="container_txt">
            ...
            <ul>
             <li>
                 <span>小学课件资源</span>
                 <a href="https://www.qspfw.com/html/primaryres/">点击查看</a>
             </li>
             <li>
                 <span>初中课件资源</span>
                 <a href="https://www.qspfw.com/html/middleres/">点击查看</a>
             </li>
             <li>
                 <span>高中课件资源</span>
                 <a href="https://www.qspfw.com/html/highres/">点击查看</a>
             </li>
            </ul>
        </div>
        <div id="footer">
