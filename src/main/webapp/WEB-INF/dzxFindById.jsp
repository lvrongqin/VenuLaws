	...
	<div id="container">
		...
		<div class="container_txt">
            <div class="backWrapper">
                <span><a href="${pageContext.request.contextPath }/FLZXXinWenDongTai">&lt;返回</a></span>
            </div>
			<div class="head_txt">
				<h1>
			...
			<div class="main_txt">
				<p>
					<%--十三届全国人大常委会第二十四次会议26日表决通过刑法修正案(十一)。其中
					规定,已满12周岁不满14周岁的人,犯故意杀人、故意伤害罪,致人死亡或者以特别残忍手段致人重伤造成
