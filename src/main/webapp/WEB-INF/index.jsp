...
<div id="container">
    <div id="header">
        <div class="login_wrapper">
            <a href="${pageContext.request.contextPath }/WEB-INF/denglu.jsp"
               id="header_top1">&nbsp;&nbsp;登录&nbsp;&nbsp;</a><span>|</span>
            <a href="${pageContext.request.contextPath }/WEB-INF/zhuce.jsp" id="header_top2">&nbsp;&nbsp;注册</a>
        </div>
        <a class="search-back">
    ...
    <div class="main">
        <div class="newsWrapper">
            <ul class="clearfix">
                <li>
                    ...
                    <ul class="newsMod1">
                        <li><a><i class="icon iconfont icon-jiantouyou"></i><span>启明普法教育团队2.25会议圆满结束</span></a>
                        </li>
                        <li><a><i class="icon iconfont icon-jiantouyou"></i><span>启明普法教育团队2.25会议圆满结束</span></a>
                        </li>
                        <li><a><i class="icon iconfont icon-jiantouyou"></i><span>启明普法教育团队2.25会议圆满结束</span></a>
        ...
        <div class="newsWrapper1 clearfix">
            <div class="leftMod">
                ...
                <ul class="newsMod5 clearfix">
                    <li><a><span style="float: left;">【启明普法】</span><span class="contentTxt">启明普法教育团队</span></a><span
                            class="timeTxt">2021-04-17</span></li>
                    <li><a><span style="float: left;">【启明普法】</span><span
        ...
        <div class="funWrapper">
            <ul class="clearfix">
                <li>
                    <a href="${pageContext.request.contextPath }/FLZXXinWenDongTai">
                        <i class="icon iconfont icon-xuexizhongxin"></i>
                        <div>学习法律知识</div>
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath }/PFJYFaZhiWenHua">
                        <i class="icon iconfont icon-haiwai"></i>
                        <div>获取法律资源</div>
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath }/hd/hjlPageData?curr=1">
                        <i class="icon iconfont icon-wenti"></i>
                        <div>提出法律问题</div>
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath }/YiAnShiFa">
                        <i class="icon iconfont icon-anli"></i>
                        <div>讲解法律案例</div>
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath }/WoYaoBaoMing">
                        <i class="icon iconfont icon-huodong3"></i>
                        <div>参与法律活动</div>
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath }/GuanYuWoMen">
            ...
            $.ajax({
                ...
                success: function (resp) {
                    for (let i = 0; i < $('.newsMod1 li').length; i++) {
                        ...
                        for (let i = 0; i < $('.newsMod1 li').length; i++)
                            $('.newsMod1 li')[i].onclick = function () {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    for (let i = 0; i < $('.newsMod2 li').length; i++) {
                        ...
                        for (let i = 0; i < $('.newsMod2 li').length; i++)
                            $('.newsMod2 li')[i].onclick = function () {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    for (let i = 0; i < $('.newsMod3 li').length; i++) {
                        ...
                        for (let i = 0; i < $('.newsMod3 li').length; i++)
                            $('.newsMod3 li')[i].onclick = function () {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    for (let i = 0; i < $('.newsMod4 li').length; i++) {
                        ...
                        for (let i = 0; i < $('.newsMod4 li').length; i++)
                            $('.newsMod4 li')[i].onclick = function () {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    for (let i = 0; i < $('.newsMod5 li').length; i++) {
                        ...
                        for (let i = 0; i < $('.newsMod5 li').length; i++)
                            $('.newsMod5 li')[i].onclick = function () {
