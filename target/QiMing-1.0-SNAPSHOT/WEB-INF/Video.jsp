...
<body>
    <div id="container">
        ...
        <div id="header">
            ...
            <a class="msg_wrapper" href="${pageContext.request.contextPath }/WoDeXinXi.jsp">
            ...
            <div id="main_nav">
                ...
                <ul id="head_nav">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath }/FLZXXinWenDongTai.jsp" title="团队动态">团队动态</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath }/YiAnShiFa.jsp" title="以案释法">以案释法</a>
                    </li>
                    <li><a href="${pageContext.request.contextPath }/PFJYFaZhiWenHua.html">普法教育</a>
                        <ul>
                            <li><a href="${pageContext.request.contextPath }/PFJYFaZhiWenHua.html">线上教育</a></li>
                            <li><a href="${pageContext.request.contextPath }/PFJYFaZhiWenHua.html">线下活动</a></li>
                            <li><a href="${pageContext.request.contextPath }/PFJYFaZhiWenHua.html">法治文化</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="TSHDMoNiFaTing.jsp">活动报名</a>
                        <ul>
                            <li><a href="${pageContext.request.contextPath }/TSHDMoNiFaTing.html">模拟法庭</a></li>
                            <li><a href="${pageContext.request.contextPath }/TSHDQiMingQingTing.html" title="启明倾听">启明倾听</a></li>
                            <li><a href="${pageContext.request.contextPath }/WoYaoBaoMing.jsp">我要报名</a></li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="container_txt">
            <div class="bigTitle">普法微视频</div>
            <ul>
                <li>
                    <span> 民法典小剧场1-熊孩子篇</span>
                    <a
                        href="http://media.legalinfo.gov.cn/wx_law/law.do?action=download&media_path=http%3A//media.legalinfo.gov.cn/file/video/20201221100441709.mp4">点击下载观看</a>
                </li>
                <li>
                    <span>民法典小剧场2-买卖不破租赁</span>
                    <a
                        href="http://media.legalinfo.gov.cn/wx_law/law.do?action=download&media_path=http%3A//media.legalinfo.gov.cn/file/video/20201221100811950.mp4">点击下载观看</a>
                </li>
                <li>
                    <span>民法典小剧场3-肖像权保护</span>
                    <a
                        href="http://media.legalinfo.gov.cn/wx_law/law.do?action=download&media_path=http%3A//media.legalinfo.gov.cn/file/video/20201221101316778.mp4">点击下载观看</a>
                </li>
            </ul>
        </div>
        <div id="footer">
