    ...
    for (var i = 0; i < liC.length; i++) {
        liC[i].onclick = function () {
            if (flag) {
                ...
                // 留自己
                if (sec.getAttribute("id") == 'one1')
                    sec.style.height ="104px";
                else if (sec.getAttribute("id")=='one2'){
                    sec.style.height = "75.2px";
                }
                else if (sec.getAttribute("id")=='one'){
                    sec.style.height ="113px";
                }
                else if (sec.getAttribute("id") == 'two1'||sec.getAttribute("id") == 'two'){
                    sec.closest("#one1").style.height = "220.8px";
                    sec.style.height = "112.8px";
                }
                else
                    sec.style.height = 1.2078 + "rem";
